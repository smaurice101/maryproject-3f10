[maryproject-3f10] Operating Details
====================================

Generated On: 2024-10-17 19:49:53 UTC
...
.. important::
   ...
   **not be valid if your [maryproject-3f10] container is NOT running**.

.. tip::
   You must have your [maryproject-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=46351  \-\-env VIPERVIZPORT=54679  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:54679/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:54679/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   maadsdocker/maryproject-3f10-amd64 (https://hub.docker.com/r/maadsdocker/maryproject-3f10-amd64)
...
.. important::
   docker run -d -p 60333:60333 -p 39171:39171 -p 59703:59703 \-\-env TSS=0 \-\-env SOLUTIONNAME=maryproject-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_dag-maryproject-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git \-\-env SOLUTIONEXTERNALPORT=60333  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=39171  \-\-env SOLUTIONVIPERVIZPORT=59703 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=46351 \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env VIPERVIZPORT=54679 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/maryproject-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=59703
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=60333
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - maadsdocker/maryproject-3f10-amd64
...
It can be accessed by entering: http://localhost:39171
...
.. important::
   http://localhost:59703/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:59703/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:59703/<html file>
...
[maryproject-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/maryproject-3f10
...
.. important::
   https://maryproject-3f10.readthedocs.io
...
.. important::
   solution_preprocessing_dag-maryproject-3f10
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=60333, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=39003, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=35257, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=35497, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=40977, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=46361, HPDEHOST=127.0.1.1, HPDEPORT=36765, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=38341

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-4780-maryproject-3f10,solution_preprocessing_dag-maryproject-3f10, python-preprocess-2897-maryproject-3f10,solution_preprocessing_dag-maryproject-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
